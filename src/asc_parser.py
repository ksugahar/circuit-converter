...
# 3端子素子 (BJT NPN): C, B, E — 実測値ベース
# NPN R0: sym(x,y) -> C=右上, B=左中, E=右下
# ワイヤ接続点の実測値:
#   C offset=(64,-48), B offset=(-80,48) or (0,48), E offset=(64,0)
# ただし端子位置はシンボル内部の接続ピンであり、ワイヤ端点とは微妙にずれる
# LTSpiceシンボルの接続ピン（実測）:
_3T_NPN = {
    'R0':   ((64, -48), (0, 48), (64, 96)),   # C, B, E
    'R90':  ((-48, -64), (48, 0), (48, -64)),
    'R180': ((64, 48), (0, -48), (64, -48)),
    'R270': ((48, 64), (-48, 0), (-48, 64)),
    'M0':   ((-64, -48), (0, 48), (-64, 48)),  # mirrored
    'M90':  ((-48, 64), (48, 0), (48, 64)),
    'M180': ((-64, 48), (0, -48), (-64, -48)),
    'M270': ((48, -64), (-48, 0), (-48, -64)),
}

_3T_PNP = {
    'R0':   ((64, 48), (0, -48), (64, -48)),   # C下, B左, E上
    'R180': ((64, -48), (0, 48), (64, 48)),
    'M0':   ((-64, 48), (0, -48), (-64, -48)),
    'M180': ((-64, -48), (0, 48), (-64, 48)),
    'R90':  ((48, -64), (-48, 0), (-48, -64)),
...
TERMINAL_OFFSETS = {
    ...
    'f':        _2T_SRC,    # CCCS
    'h':        _2T_SRC,    # CCVS
    'bv':       _2T_SRC,    # Behavioral voltage
    'bi':       _2T_SRC,    # Behavioral current
    'bi2':      _2T_SRC,
